...
const HowItWork = () => {
  return (
    <div className="relative flex flex-col items-center justify-center w-full p-10 bg-white shadow-md rounded-lg mt-10">
      <span className="absolute right-0 top-0 m-4 px-3 py-1 bg-red-600 text-white text-sm font-bold rounded-full">
        مهم جدا!
      </span>
      <div className="flex flex-col items-center container">
        <h1 className="text-4xl font-bold p-5 text-center">كيف تعمل المنصة؟</h1>
